...
The parallelized calculation of PI has been chosen to compare different parallel computing technologies by benchmarking the calculation of PI. Thus a short program has been written meeting the special requirements of the technologies. Notably these technologies are the MPICH2 implementation of the message passing interface (MPI), the Threads library from the new C++11 standard and OpenMP API from the OpenMP consortium.\\
...
The latest version of the C++ standard C++11 released in late 2011 supports parallelization by multithreaded programming. The C++11 standard library provides a thread class which takes a function object to start a new thread. The concept for inter thread communication is synchronization. In order to compile the PI calculation program gcc tool chain has been set up.\\
...
\section{Methods}
The description of methods goes here.

\section{Empirical Results}
The empirical results are going here.

\begin{figure}[!ht]
	\includegraphics[scale=0.5]{graphics/ex01.png}
	\caption{Benchmark for 100000000 rectangles.}
	\label{img:ex01}
\end{figure}
